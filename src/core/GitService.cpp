...
bool GitService::runGit(const QString &workingDir,
...
bool GitService::getConfigValue(const QString &workingDir,
                                const QString &key,
                                bool global,
                                QString *value,
                                QString *output) const
...
bool GitService::setConfigValue(const QString &workingDir,
                                const QString &key,
                                const QString &value,
                                bool global,
                                QString *output) const
