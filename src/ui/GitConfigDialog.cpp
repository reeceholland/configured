...
GitConfigDialog::GitConfigDialog(GitService* gitService, const QString& workingDir, QWidget* parent)
    : QDialog(parent), gitService_(gitService), workingDir_(workingDir) {
